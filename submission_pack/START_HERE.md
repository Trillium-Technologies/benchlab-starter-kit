...
3. Do not start adapting the package until the example passes locally.  Adapt `submission_pack/' to your own forecasting workflow:
...
4. Test the complete workflow locally again with local_tests/test_local.sh. Repeat this throughout development.
